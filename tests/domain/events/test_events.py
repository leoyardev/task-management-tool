...
class TestImmutability:
    ...
    def test_deadline_approaching_is_immutable(self, task_id, task_title, now):
        event = DeadlineApproaching(task_id=task_id, task_title=task_title, deadline=now)
        with pytest.raises(Exception):
...
class TestTaskCompleted:
    ...
    def test_task_id_is_uuid(self, task_id, task_title):
        assert isinstance(TaskCompleted(task_id=task_id, task_title=task_title).task_id, UUID)
 
    def test_task_title_is_string(self, task_id, task_title):
        assert isinstance(TaskCompleted(task_id=task_id, task_title=task_title).task_title, str)
